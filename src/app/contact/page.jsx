                                    ...
                                    <form  onSubmit={handleSubmit} className='form-block flex flex-col justify-between gap-5'>
                                        ...
                                        <div className='grid sm:grid-cols-2 gap-5'>
                                            <div className='w-full'>
                                                <input type="text" name="name" placeholder='Name'   value={formData.name} onChange={handleChange}  className='w-full bg-slate-100 text-secondary caption1 px-4 py-3 rounded-lg'  /> 
                                            </div>
                                            ...
                                            <div className='w-full'>
                                                <input type="text" name="subject" placeholder='Subject'    value={formData.subject} onChange={handleChange}   className='w-full bg-slate-100 text-secondary caption1 px-4 py-3 rounded-lg'  /> 
                                            </div>
                                            ...
                                            <div className='col-span-2 w-full'>
                                                <textarea name="message" id="message" rows={4} placeholder='Your Message'     value={formData.message} onChange={handleChange}       className='w-full bg-slate-100 text-secondary caption1 px-4 py-3 rounded-lg' ></textarea> 
                                            </div>
