                ...
                <div className='lg:w-1/4'>
                    <div className='footer-company-infor flex flex-col justify-between gap-5'>
                        ...
                        <div className='list-social flex items-center gap-2'>
                            ...
                            {
                                footer.youtube && ( 
                                        <Link className='item rounded-full w-7 h-7 border-2 border-gray flex items-center justify-center' href={footer.youtube} target='_blank'>
                                            <i className='icon-youtube text-xs'></i>
                                        </Link>
                                ) 
                            }
                ...
                <div className='lg:w-1/4'>
                    <div className='company-contact'>
                        ...
                        <form className='send-block mt-5 flex items-center h-[45px] rounded-lg overflow-hidden'>
                            <input className='bg-white text-secondary h-full w-full pr-4 pl-3' type="text" placeholder='Your Email Address' />
