                ...
                <div className='row flex max-lg:flex-col lg:items-center gap-y-6'>
                    ...
                    <div className='w-full lg:w-1/2 flex-col lg:pl-20'>
                        ...
                        <div className='button-block flex items-center gap-5 md:mt-10 mt-6 pb-2'>
                            ...
                            <a href="#" className='button-main text-on-surface hover:bg-black hover:text-white hover:border-transparent bg-white text-button rounded-full border-2 border-blue-800 flex items-center gap-2'> {about.phone}</a>
