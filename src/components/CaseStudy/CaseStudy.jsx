                    ...
                    <div className='list grid lg:grid-cols-4 sm:grid-cols-2'>
                        ...
                        <div className='w-full'>
                            <div className='case-study-item'>
                                ...
                                <div className='bg-img'>
                                    <Image width={5000} height={5000} className='w-full h-full block' src='/images/caseone.webp' alt='img' /> 
                                </div>
                                ...
                                <div className='text flex flex-col justify-between gap-3'>
                                    ...
                                    <div className='body2 text-white'>
                                       We are committed to providing reliable and high-quality financial advisory in our services.
                                    </div>
                        ...
                        <div className='w-full'>
                            <div className='case-study-item'>
                                ...
                                <div className='bg-img'>
                                    <Image width={5000} height={5000} className='w-full h-full block' src='/images/casetwo.webp' alt='img' /> 
                                </div>
                                ...
                                <div className='text flex flex-col justify-between gap-3'>
                                    ...
                                    <div className='body2 text-white'>
                                        With an experienced and skilled team, we bring the necessary expertise to enhance work productivity.
                                    </div>
                        ...
                        <div className='w-full'>
                            <div className='case-study-item'>
                                ...
                                <div className='text flex flex-col justify-between gap-3'>
                                    ...
                                    <div className='body2 text-white'>
                                        EWe constantly seek advanced solutions to address challenges and deliver the highest value to our customers.
                                    </div>
